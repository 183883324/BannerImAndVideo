...
public class QSVideoView extends FrameLayout implements IVideoPlayer, IMediaCallback,IOnItemClickListener {
    ...
    public static void setOnclickBa(OnclickBa onclickBa) {
        QSVideoView.onclickBa = onclickBa;
    }
    ...
    //接口
    public interface OnclickBa {
        void OnclickBa(String txt);
    }
}
